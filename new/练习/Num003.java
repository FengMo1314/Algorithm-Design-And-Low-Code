...
public class Num003 {
	 ...
	 * @param args
	 */
	/*丑数队列  ：1,2,3,4,5,6,8,9,10,12,15，.....
	 * 分队列：
	 *2倍数队列：2,4,6,8,10,12,16,18,20,24,30
	 *3倍数队列：3,6,9,12,15,18,24,27,30,36,45
	 *5倍数队列：5,10,15,20,25,30,40,45,50,60,75
	 *每次依次提取分队列中的首位数字，保留3者中最小的添加到结果，只有被提取过得队列依次向后，其余队列不动
	 *如：第一次提取：(2,3,5),保留(2)
	 *          第二次提取：(4,3,5),保留(3)
	 *          第三次提取：(4,6,5),保留(4)
	 *          第四次提取：(6,6,5),保留(5)
	 ...
	 *          第六次提取：(8,9,10),保留(8)
	 *          第七次提取：(10,9,10),保留(9)
	 *          第八次提取：(10,12,10),保留(10)
	 *          第九次提取：(12,12,15),保留(12)
	 */
